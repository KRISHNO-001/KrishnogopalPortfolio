    ...
    <div className='min-w-screen overflow-x-hidden scroll-smooth '>
      <div className='flex flex-col w-[100%] mx-auto justify-center items-center mt-20'>
        ...
        <div className='flex flex-col gap-6 items-center'>
          ...
          <div className='min-h-max w-[90vw] relative flex flex-col rounded-md pb-6 items-center sm:px-2 bg-gray-100'>
            ...
            <div className='flex flex-col gap-6 items-center min-w-[40%] sm:min-w-[100%]'>
              <div className='flex justify-around gap-6 sm:gap-3 self-start
                 text-[18px] sm:text-[15px]'><IoMdSchool fontSize={30} /><h2>B.Tech<br />in  CSE<br /><span className='text-[10px] text-gray-500 font-semibold text-center leading-3'>NSHM knowledge <br /> Campus , DURGAPUR<br />
                  MAKAUT UNIVERSITY,<br/> CGPA - 8.54</span></h2></div>

              <div className='flex justify-around gap-6 sm:gap-1 self-end 
                text-[18px] sm:text-[15px]'><IoMdSchool fontSize={30} /><h2>Senior Secondary<br /><span className='text-[10px] text-gray-500 font-semibold text-center leading-3'>DAV Public School <br /> CBSE - 70%<br />
                </span></h2></div>

              <div className='flex justify-around gap-6 sm:gap-1 self-start
                 text-[18px] sm:text-[15px]'><IoMdSchool fontSize={30} /><h2>Secondary<br /><span className='text-[10px] text-gray-500 font-semibold text-center leading-3'>DAV Public School <br /> CBSE - 87%<br />
                </span></h2></div>
            </div>
