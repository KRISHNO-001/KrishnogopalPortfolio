      ...
      <div className='flex flex-col items-center'>
        <div className='flex flex-col items-center'>
          ...
          <div className='flex flex-col bg-blue-100 rounded-md min-w-[96vw]'>
            ...
            <div className='self-center  flex flex-col my-10  sm:w-[96%]'><img className='border-[10px] border-red-300' src={razorpay} width={750} />
              <div className='flex mt-5 justify-end min-w-[100%] gap-4'><p className=' text-blue-600 font-bold'><span className='text-red-400'>Tech Stack :</span> Html ,CSS ,  & Tailwind CSS</p><AiOutlineGithub fontSize={30} /><ImLink fontSize={30} /></div>
            </div>
            <div><h2 className='text-[40px] ml-4 font-sa font-bold  sm:text-[25px]'>II. Personal Portfolio website</h2></div>
            <div className='self-center my-10 font-sa font-bold  sm:w-[96%] '><img className='border-[10px] border-gray-700' src={portfolio} width={750} />
              <div className='flex mt-5 justify-end min-w-[100%] gap-4'><p className='text-blue-600 font-bold'><span className='text-red-400'>Tech Stack :</span> ReactJs, Html ,CSS , & Tailwind CSS ,STMP</p><AiOutlineGithub fontSize={30} /><ImLink fontSize={30} /></div>
            </div>
            <div><h2 className='text-[40px] ml-4 font-sa font-bold   sm:text-[25px]'>III. Discord landing page clone</h2></div>
            <div className='self-center my-10 sm:w-[96%] '><img className='border-[10px] border-red-300' src={discord} width={750} />
              <div className='flex mt-5 justify-end min-w-[100%] gap-4'><p className=' text-blue-600 font-bold'><span className='text-red-400'>Tech Stack :</span>Html ,CSS , & Tailwind CSS</p> <AiOutlineGithub fontSize={30} /><ImLink fontSize={30} /></div>
            </div>
          </div>
        </div>
